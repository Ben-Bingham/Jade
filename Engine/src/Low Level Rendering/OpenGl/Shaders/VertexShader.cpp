	...
	namespace OpenGL {
		namespace Shaders {
			...
			VertexShader::VertexShader(std::string& path)
				: m_Shader(glCreateShader(GL_VERTEX_SHADER)), m_ShaderSourceFile(Jade::Resources::TextFile(path)) {
			...
			VertexShader::VertexShader(std::string&& path)
				: m_Shader(glCreateShader(GL_VERTEX_SHADER)), m_ShaderSourceFile(std::move(Jade::Resources::TextFile(path))) {
