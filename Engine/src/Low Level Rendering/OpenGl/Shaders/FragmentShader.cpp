	...
	namespace OpenGL {
		namespace Shaders {
			...
			FragmentShader::FragmentShader(std::string& path)
				: m_Shader(glCreateShader(GL_FRAGMENT_SHADER)), m_ShaderSourceFile(Jade::Resources::TextFile(path)) {
			...
			FragmentShader::FragmentShader(std::string&& path)
				: m_Shader(glCreateShader(GL_FRAGMENT_SHADER)), m_ShaderSourceFile(std::move(Jade::Resources::TextFile(path))) {
